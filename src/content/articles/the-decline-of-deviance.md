...
featured: true
deviantMode: "marginalia"
curatorNotes: "Do you ever feel like everything around you looks and feels the same? As if there's no creativity, no variation? Do you sense a kind of homogeneity everywhere — people playing it safe, less willing to take risks, more eager to conform? If you've ever had that feeling, then this article is for you. Adam Mastroianni assembles a remarkable range of data points showing there's been a sort of recession in weirdness everywhere. Teenage deviance is down. Adult crime is down. Serial killings are down. Cults are collapsing. Culture is stagnating—we're reading the same comic-book heroes from the 1960s, and 75% of today's top films are sequels or spinoffs. Music sounds homogeneous. Novel covers look alike. The internet isn't weird anymore. Every website follows the same minimalist template. Every café and Airbnb looks identical. Brand logos have converged on sans-serif fonts. Architecture, cars, offices—all flattened into gray. Why does this matter? Because if everyone thinks the same way and plays it safe, where will innovation come from? Deviant thinking has always been at the heart of discovery and art. Mastroianni even shows data suggesting scientific progress itself has slowed. His theory about why this is happening is fascinating—it's about how the value of life itself has changed."
excerpt: "People are less weird than they used to be. From crime rates to cult formation, from scientific breakthroughs to website design, deviance is declining across every sector of society. Adam Mastroianni asks: in becoming safer and richer, have we sacrificed the strange thinking that drives progress?"
pullQuote: "For the first time in history, weirdness is a choice. And it's a hard one, because we have more to lose than ever."
marginalia: [
  {
    section: "intro",
    note: "The data here is staggering. This isn't cultural criticism—it's empirical documentation of homogenization.",
    position: "early"
  },
  {
    section: "teens",
    note: "Worth noting: teen behavior getting 'better' by conventional metrics doesn't mean they're happier or more fulfilled.",
    position: "middle"
  },
  {
    section: "creativity",
    note: "The pop culture oligopoly is real. Before 2000: 25% sequels. Now: 75%. We're living in the age of IP exhaustion.",
    position: "late"
  },
  {
    section: "design",
    note: "Every cafe, every logo, every website—all converging on the same aesthetic. This is what prompted me to question this very site's design.",
    position: "middle"
  },
  {
    section: "science",
    note: "The 'weird nerd flight from academia' is a phenomenon I've witnessed firsthand. The people who stay are smart but rarely boat-rockers.",
    position: "late"
  },
  {
    section: "value-of-life",
    note: "THIS IS THE KEY INSIGHT. Life is literally worth more now. We're playing on 'slow mode.' Everything must last: joints, skin, reputation.",
    position: "middle"
  },
  {
    section: "di-modica",
    note: "Could you do this today? Run away, study art, illegally build a studio, dump sculpture on Wall Street? Every step is now inadvisable/impossible.",
    position: "late"
  },
  {
    section: "conclusion",
    note: "We need new institutions, new corners where strange things can grow. But who will dig the illegal holes in the basement?",
    position: "final"
  }
]
---
